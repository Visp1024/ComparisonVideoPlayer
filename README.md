...
- Раскладка «только A / оба кадра / только B» таблеткой в панели или по `V`,
  выбор мастер-трека таблеткой рядом со шкалой или по `M`.
...
- Открыт один ролик — плеер это и показывает: пропадают буквы треков над кадром,
  в счётчике кадров, в шапке и у левого края дорожек таймлайна, выбор раскладки
  и вкладки A / B боковой панели.
