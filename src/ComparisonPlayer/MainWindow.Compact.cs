...
///
/// Раз старт всегда компактный, свёрнутый вид стоит и в умолчаниях разметки: иначе первый
/// кадр окна показывал бы таймлайн с полным транспортом, и он схлопывался бы уже на глазах
/// у пользователя (задача #37).
/// </remarks>
