...
public sealed class CacheEntry
{
    ...
    /// <summary>
    /// Версия звуковой дорожки прокси; пусто — запись собрана до того, как прокси
    /// научился нести звук (задача #20). В ключ кэша это не входит намеренно: звук
    /// не влияет на кадры, и обесценивать из-за него собранные прокси неправильно —
    /// такая запись просто играет молча, а панель кэша предлагает собрать её заново.
    /// </summary>
